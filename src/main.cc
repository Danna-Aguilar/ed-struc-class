...
int main()
{
    ...
    Hero** heroList
    {
        new Hero*[4]
        {
            ...
            new Hero(4, 3, 1, 2, 3, 1, new std::string[4]{{"Invisible"}, {"Flash"}, {"rays sword"}, {"fly"}}),
            new Hero(7, 3, 1, 2, 3, 1, new std::string[4]{{"Super fuerza"}, {"fire ball"}, {"rapidez"}, {"invisibilidad"}}),
